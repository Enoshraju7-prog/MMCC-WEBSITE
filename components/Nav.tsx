          ...
          <div ref={utilRef} style={{ position: 'relative' }}>
            ...
            {utilOpen && (
              <div style={{
                ...
                {/* WhatsApp */}
                <a
                  href="https://wa.me/919848377309?text=Hi%20MM%20Car%20Care!%20I%27d%20like%20to%20enquire%20about%20a%20service."
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => setUtilOpen(false)}
                  style={{
                ...
                >
                  <div style={{
                    ...
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="rgba(255,255,255,0.6)">
                      ...
                      <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.553 4.122 1.522 5.862L0 24l6.302-1.495A11.943 11.943 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.893 0-3.668-.525-5.184-1.437l-.371-.22-3.742.887.939-3.636-.242-.374A9.946 9.946 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/>
                    </svg>
                  </div>
                  <div>
                    <div style={{ fontFamily: 'var(--font-space-mono, monospace)', fontSize: '9px', letterSpacing: '1.2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: '2px' }}>
