      ...
      >
        ...
        <div className="founder-bio" style={{ paddingTop: 'clamp(0px, 2vw, 24px)' }}>
          ...
          {[
            ...
            'Over 25 years, MM Car Care has grown from a mobile detailing service to a full-service garage — without ever compromising on the principles that started it. Trained hands. Professional products. The same meticulous attention to detail that earned the trust of over 1,000 customers across the region.',
